"""
Django settings for fdsggsd_dev_136377 project.
...
ROOT_URLCONF = 'fdsggsd_dev_136377.urls'
...
WSGI_APPLICATION = 'fdsggsd_dev_136377.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "fdsggsd Support <support@fdsggsd-dev-136377.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fdsggsd_dev_136377 API",
    "DESCRIPTION": "API documentation for fdsggsd_dev_136377 App",
    "VERSION": "v1",
}
